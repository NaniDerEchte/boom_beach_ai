...
# Da Google eine Bot abfrage macht benötigen wir cookies. Diese kann man ganz einfach aus seinem eigenen Browser Extrahieren. Für Chrome gibts diese Erweiterung: https://chromewebstore.google.com/detail/get-cookiestxt-locally/cclelndahbckbenkjhflpdbgdldlbecc
# Ist eigentlich selbsterklärend, man muss nur Angemeldet sein mit einem Google Account. Am besten auf https://www.youtube.com/ gehen und von da die Cookies nehmen und als Datei speichern.
# Bedenke das die Cookies aber nach 1-2h nicht mehr gültig sind, das heißt du musst immer mal wieder die Cookies tauschen.
